    ...
    <div className="bg-black min-h-screen flex flex-col relative">
      ...
      <section className="relative py-20 lg:py-32 flex items-center justify-center overflow-hidden mb-16 lg:mb-24">
        <div className="absolute inset-0 z-0">
          <img src="/apexmandmcarpic2.jpg" alt="Paint Protection Film Background" className="w-full h-full object-cover object-center opacity-60 grayscale" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-8">
            <h2 className="text-3xl font-bold text-white font-serif uppercase tracking-wider mb-6">
              INVISIBLE <span className="text-primary">ARMOR</span>
            </h2>
            
            <div className="prose prose-invert prose-lg max-w-none text-gray-300">
              <p className="leading-relaxed font-light text-lg">
                Rock chips, debris, and environmental damage are the fastest ways to degrade your vehicle's value and aesthetics. Our Paint Protection Film (PPF) provides a durable, self-healing, optically clear layer of urethane that acts as an invisible shield for your high-impact areas or the entire vehicle.
              </p>
              
              <p className="leading-relaxed font-light mt-6">
                Apex Marine & Motors utilizes precision computer-cut templates to ensure a perfect, seamless fit without the need for blades near your factory paint. Combined with its self-healing properties, minor scratches and swirl marks disappear with the application of heat, keeping your finish completely flawless.
              </p>
              ...
              <div className="bg-dark-bg/80 border-l-4 border-primary p-6 mt-10 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                 <p className="italic text-white text-xl font-serif">
                   "Drive with total peace of mind. Our PPF absorbs the impact so your original paint doesn't have to."
                 </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-10">
               <div className="flex flex-col gap-3">
                 ...
                 <h4 className="text-white font-bold tracking-wide uppercase">Precision Fit</h4>
                 <p className="text-gray-400 text-sm">Computer-cut patterns for a flawless, invisible installation.</p>
               </div>
               <div className="flex flex-col gap-3">
                 <ShieldCheck className="text-primary w-8 h-8" />
                 <h4 className="text-white font-bold tracking-wide uppercase">Self-Healing</h4>
                 <p className="text-gray-400 text-sm">Minor scratches vanish automatically with sun or heat.</p>
               </div>
               <div className="flex flex-col gap-3">
                 <ThumbsUp className="text-primary w-8 h-8" />
                 <h4 className="text-white font-bold tracking-wide uppercase">Preserve Value</h4>
                 <p className="text-gray-400 text-sm">Maintains factory paint condition for maximum resale value.</p>
               </div>
            </div>
          </div>
