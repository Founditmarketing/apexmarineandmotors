    ...
    <div className="bg-black min-h-screen flex flex-col relative">
      ...
      <section className="relative py-20 lg:py-32 flex items-center justify-center overflow-hidden mb-16 lg:mb-24">
        <div className="absolute inset-0 z-0">
          <img src="/apexmandmpic1.jpg" alt="About Us Background" className="w-full h-full object-cover object-center opacity-60 grayscale" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-8">
            <h2 className="text-3xl font-bold text-white font-serif uppercase tracking-wider mb-6">
              A ROCK SOLID <span className="text-primary">REPUTATION</span>
            </h2>
            
            <div className="prose prose-invert prose-lg max-w-none text-gray-300">
              <p className="leading-relaxed font-light text-lg">
                Our dealership has a rock-solid reputation for providing excellent service, support, and absolute customer satisfaction. We pride ourselves on giving our clients the highest tier of service available, the best parts and accessories on the market, and a highly specialized staff that intimately understands all aspects of our business.
              </p>
              
              <p className="leading-relaxed font-light mt-6">
                Apex Marine & Motors isn't just another dealership; we are an elite group of marine and automotive enthusiasts dedicated to preserving, enhancing, and representing high-value assets. Whether you're trusting us with a high-end ceramic coating, complex fiberglass restoration, or stress-free consignment, we treat every vessel and vehicle as if it were our own.
              </p>
              ...
              <div className="bg-dark-bg/80 border-l-4 border-primary p-6 mt-10 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                 <p className="italic text-white text-xl font-serif">
                   "We refuse to compromise on quality. Our white-glove approach ensures that when you leave our shop, you're experiencing perfection."
                 </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-10">
               <div className="flex flex-col gap-3">
                 ...
                 <h4 className="text-white font-bold tracking-wide uppercase">Top Installers</h4>
                 <p className="text-gray-400 text-sm">Certified premium coating specialists.</p>
               </div>
               <div className="flex flex-col gap-3">
                 <ShieldCheck className="text-primary w-8 h-8" />
                 <h4 className="text-white font-bold tracking-wide uppercase">Trusted Products</h4>
                 <p className="text-gray-400 text-sm">Industry-leading marine & auto compounds.</p>
               </div>
               <div className="flex flex-col gap-3">
                 <ThumbsUp className="text-primary w-8 h-8" />
                 <h4 className="text-white font-bold tracking-wide uppercase">Satisfaction</h4>
                 <p className="text-gray-400 text-sm">Unwavering dedication to customer focus.</p>
               </div>
            </div>
          </div>
