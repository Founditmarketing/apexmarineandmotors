    ...
    <div className="bg-black min-h-screen flex flex-col relative">
      ...
      <section className="relative py-20 lg:py-32 flex items-center justify-center overflow-hidden mb-16 lg:mb-24">
        <div className="absolute inset-0 z-0">
          <img src="/apexmandmcarpic1.jpg" alt="Ceramic Coatings Background" className="w-full h-full object-cover object-center opacity-60 grayscale" />
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white uppercase font-serif tracking-wide mb-6">
            CERAMIC <span className="text-primary">COATINGS</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-8">
            <h2 className="text-3xl font-bold text-white font-serif uppercase tracking-wider mb-6">
              ULTIMATE <span className="text-primary">PROTECTION</span>
            </h2>
            
            <div className="prose prose-invert prose-lg max-w-none text-gray-300">
              <p className="leading-relaxed font-light text-lg">
                Protect your investment against the harsh marine environment and unforgiving road conditions. Our premium ceramic coatings provide a permanent, glass-like shield over your paint, gelcoat, and trim, offering unmatched gloss, self-cleaning properties, and resistance to UV rays, salt water, and chemical contaminants.
              </p>
              
              <p className="leading-relaxed font-light mt-6">
                As the #1 Apex Installers in the region, we don't just apply a product—we perfect the surface beforehand. Every ceramic coating package includes meticulous paint correction and preparation to ensure the coating bonds flawlessly and locks in a mirror-like finish that lasts for years.
              </p>
              ...
              <div className="bg-dark-bg/80 border-l-4 border-primary p-6 mt-10 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                 <p className="italic text-white text-xl font-serif">
                   "Never wax your boat or car again. Our coatings provide a sacrificial layer of armor that keeps your asset looking showroom new."
                 </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-10">
               <div className="flex flex-col gap-3">
                 ...
                 <h4 className="text-white font-bold tracking-wide uppercase">Elite Installers</h4>
                 <p className="text-gray-400 text-sm">Certified in the industry's highest grade ceramic tech.</p>
               </div>
               <div className="flex flex-col gap-3">
                 <ShieldCheck className="text-primary w-8 h-8" />
                 <h4 className="text-white font-bold tracking-wide uppercase">UV & Salt Armor</h4>
                 <p className="text-gray-400 text-sm">Extreme resistance against the harshest elements.</p>
               </div>
               <div className="flex flex-col gap-3">
                 <ThumbsUp className="text-primary w-8 h-8" />
                 <h4 className="text-white font-bold tracking-wide uppercase">Extreme Gloss</h4>
                 <p className="text-gray-400 text-sm">A permanent, candy-like luster that repels dirt and water.</p>
               </div>
            </div>
          </div>
