...
export default function FiberglassRepairPage() {
  return (
    <div className="bg-black min-h-screen flex flex-col relative">
      ...
      <section className="relative py-20 lg:py-32 flex items-center justify-center overflow-hidden mb-16 lg:mb-24">
        <div className="absolute inset-0 z-0">
          <img src="/apexmandmpic1.jpg" alt="Fiberglass Repair Background" className="w-full h-full object-cover object-center opacity-60 grayscale" />
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white uppercase font-serif tracking-wide mb-6">
            FIBERGLASS <span className="text-primary">REPAIR</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-8">
            <h2 className="text-3xl font-bold text-white font-serif uppercase tracking-wider mb-6">
              SEAMLESS <span className="text-primary">RESTORATION</span>
            </h2>
            
            <div className="prose prose-invert prose-lg max-w-none text-gray-300">
              <p className="leading-relaxed font-light text-lg">
                Fiberglass damage compromises the structural integrity and aesthetic value of your marine vessel. Our expert fiberglass repair services address everything from minor gelcoat scratches to major structural impacts. Using advanced marine-grade resins and meticulous color matching, we seamlessly restore the affected area.
              </p>
              
              <p className="leading-relaxed font-light mt-6">
                We don't just patch the damage; we rebuild it to factory specifications. Once the structural integrity is restored, our technicians painstakingly blend and polish the gelcoat so that the repair is entirely invisible, preserving the value and beauty of your boat.
              </p>
              ...
              <div className="bg-dark-bg/80 border-l-4 border-primary p-6 mt-10 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                 <p className="italic text-white text-xl font-serif">
                   "We perform structural miracles. When we're finished, you'll never know the damage was even there."
                 </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-10">
               <div className="flex flex-col gap-3">
                 ...
                 <h4 className="text-white font-bold tracking-wide uppercase">Structural Integrity</h4>
                 <p className="text-gray-400 text-sm">We use top-tier marine resins for maximum strength.</p>
               </div>
               <div className="flex flex-col gap-3">
                 <ShieldCheck className="text-primary w-8 h-8" />
                 <h4 className="text-white font-bold tracking-wide uppercase">Gelcoat Matching</h4>
                 <p className="text-gray-400 text-sm">Perfect color and texture blending for invisible repairs.</p>
               </div>
               <div className="flex flex-col gap-3">
                 <ThumbsUp className="text-primary w-8 h-8" />
                 <h4 className="text-white font-bold tracking-wide uppercase">Complete Restoration</h4>
                 <p className="text-gray-400 text-sm">From minor scratches to major collision damage.</p>
               </div>
            </div>
          </div>
