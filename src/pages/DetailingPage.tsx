    ...
    <div className="bg-black min-h-screen flex flex-col relative">
      ...
      <section className="relative py-20 lg:py-32 flex items-center justify-center overflow-hidden mb-16 lg:mb-24">
        <div className="absolute inset-0 z-0">
          <img src="/apexmandmcarpic3.jpg" alt="Detailing Background" className="w-full h-full object-cover object-center opacity-60 grayscale" />
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white uppercase font-serif tracking-wide mb-6">
            EXPERT <span className="text-primary">DETAILING</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-8">
            <h2 className="text-3xl font-bold text-white font-serif uppercase tracking-wider mb-6">
              BEYOND <span className="text-primary">CLEAN</span>
            </h2>
            
            <div className="prose prose-invert prose-lg max-w-none text-gray-300">
              <p className="leading-relaxed font-light text-lg">
                True detailing is an art form that goes far beyond a simple wash. At Apex Marine & Motors, our expert detailing services restore your vehicle or vessel to better-than-factory condition. We meticulously clean, correct, and protect every square inch, from the deepest carpet fibers to the most delicate clear coat.
              </p>
              
              <p className="leading-relaxed font-light mt-6">
                Using specialized tools, steam cleaners, and premium compounds, we eliminate oxidation, water spots, swirl marks, and embedded contaminants. Whether it's a luxury sports car or a high-performance marine vessel, our comprehensive interior and exterior detailing packages deliver a flawless, breathtaking finish.
              </p>
              ...
              <div className="bg-dark-bg/80 border-l-4 border-primary p-6 mt-10 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                 <p className="italic text-white text-xl font-serif">
                   "We don't just wash; we restore. Every crevice, every surface, meticulously perfected to a showroom standard."
                 </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-10">
               <div className="flex flex-col gap-3">
                 ...
                 <h4 className="text-white font-bold tracking-wide uppercase">Deep Restoration</h4>
                 <p className="text-gray-400 text-sm">Comprehensive paint correction and interior deep-cleaning.</p>
               </div>
               <div className="flex flex-col gap-3">
                 <ShieldCheck className="text-primary w-8 h-8" />
                 <h4 className="text-white font-bold tracking-wide uppercase">Premium Products</h4>
                 <p className="text-gray-400 text-sm">We only use the safest, most effective detailing compounds.</p>
               </div>
               <div className="flex flex-col gap-3">
                 <ThumbsUp className="text-primary w-8 h-8" />
                 <h4 className="text-white font-bold tracking-wide uppercase">Total Perfection</h4>
                 <p className="text-gray-400 text-sm">Unmatched attention to detail for an immaculate result.</p>
               </div>
            </div>
          </div>
